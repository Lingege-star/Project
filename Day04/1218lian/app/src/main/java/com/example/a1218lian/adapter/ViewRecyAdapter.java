...
public class ViewRecyAdapter extends RecyclerView.Adapter {
    private Context context;
    private ArrayList<ViewBean.DataBeanX.DataBean> list;

    public ViewRecyAdapter(Context context, ArrayList<ViewBean.DataBeanX.DataBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_viewrecy, parent, false);
    ...
    public static
    class ViewHolder extends PicRecyAdapter.ViewHolder {
