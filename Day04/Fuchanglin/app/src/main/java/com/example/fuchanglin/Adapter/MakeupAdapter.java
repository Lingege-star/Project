...
public class MakeupAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<MakeupData.DataBean.ListBean> list;

    public MakeupAdapter(Context context, List<MakeupData.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        MakeupData.DataBean.ListBean listBean = list.get(position);
